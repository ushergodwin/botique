...
<!-- side bar -->
    ...
    <div class="container">
        ...
        <div class="col-sm-12 col-md-6 col-lg-3">
               ...
               <div class="card card-body card-size mt-3 shadow">
            ...
            <input type='hidden' name='code' value="<?php echo $row['code'];?>" />
              <input type='hidden' name='category' value="<?php echo $row['category'];?>" />
                ...
                <p class="text-muted">UGX: <?php echo number_format($row['price']);?></p>
                   ...
                   <p class="text-muted d-inline-block text-truncate" style="max-width: 550pt;"><?php echo $row['description'];?></p><a data-toggle="tooltip" title="<?php echo $row['description'];?>" class="description text-primary">Read More</a>
