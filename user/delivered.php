...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <a href="admin.php" class="btn btn-outline-light btn-sm">ALL ORDERS</a> &nbsp; &nbsp;        
                ...
                <a href="delivered.php" class="btn btn-outline-light btn-sm active">DELIVERD ORDERS <span><?php echo"&nbsp;".$delivered."&nbsp;"; ?></span></a>&nbsp; &nbsp;     
...
<div class="container-fluid">
  <div id="hidden">
    ...
    <a href="order-status.php" class="btn btn-outline-light btn-sm">Update Order Status</a><br><br>
        <a href="order_no.php" class="btn btn-outline-light btn-sm">Check for Order NO</a><br><br>
