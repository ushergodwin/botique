...
<script>
  ...
  <meta name="author" content="Tumuhimbise Usher Godwin">
	<title>GemasGlamHome FAQs</title>
...
#mobileSearch{border-radius: 50px; border-top-right-radius: 1px; border-bottom-right-radius: 1px;</style></head>
<body> <a name="top"></a> 
  <!-- navigation bar for desktop -->
<nav class="navbar navbar-expand-md sticky-top" id="top_nav"><a href="index.php" class="navbar-brand"><img src="imgs/gemasglam.jpg" height="50" width="100" style="border-radius: 5px;"></a><div class="collapse navbar-collapse justify-content-between" id="navbarCollapse"><div class="navbar-nav">
    <a href="faqs.php">FAQs</a> </div><div class="nav-item dropdown"> <a href="#" class="nav-link dropdown-toggle"
...
<div class="col-md-12 col-lg-12 col-sm-12">
	...
	<div class="card">
        <h4 class="card-header text-light bg-dark">Here are answers to questions that are often asked:</h4>
		<div class="card-body">
            <h4 style="text-decoration: underline;" class="text-muted">Purchasing Items /Store Locations</h4>
			<h5 class="text-muted">Gemasglam glam home is currently only available online as we aim to keep our pricing competitive whist offering a very bespoke service.</h5><h4 style="text-decoration: underline;" class="text-muted">Size Charts & Size Ranges</h4><h5 class="text-muted">All of our dresses are available in sizes <b>XS, S, M, L, XL, and XXL</b>. We want to accommodate all shapes and sizes. If you require a larger size, please contact us to discuss your requirements.</h5><h4 style="text-decoration: underline;" class="text-muted">Delivery & Lead times</h4><h5 class="text-muted">Delivery dates for all clothing items and other items ordered through the website are typically the same day or 1-2days for stock items. We can 'RUSH' orders if you need a quick delivery. We are fairly flexible and hope to accommodate as many orders as possible. To rush an order please contact us on WhatsApp or give a phone call on &nbsp;<a href="tel:+256709655944" style="font-size: 30pt;"><i class="fas fa-phone-alt"></i></a><small>click to call</small> <h4 style="text-decoration: underline;" class="text-muted">Returns & Exchanges</h4><h5 class="text-muted">For Stock items, you have 14 days from the date of dispatch to return for a full refund. For Made to Order items we charge a return processing fee of<b> UGX 20000/=</b> for clothing items and<b> UGX 12000/=</b> for any other item. We are happy to replace defective merchandise or exchange sizes on In Stock clothing items only if requested within 3 days of receipt. If you require an exchange or replacement on in-stock items, please email us at<a href="mailto:wecare@gemasglam.com"> wecare@gemasglam.com</a> or call and WhatsApp us on <br><a href="https://wa.me/+256709655944" style="font-size: 30pt;"><i class="fab fa-whatsapp-square text-success"></i></a><small>click to whatsapp</small> &nbsp;and you can as well check out for the full details of our<a href="return-policy.php"> return policy.</a></h5>
</h5>
	</div>
</div>	
</div>
