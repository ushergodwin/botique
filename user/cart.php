...
<?php }?>
      <tr>
<td><a href="HOME.php" class="btn btn-primary btn-sm">Continue Shopping</a></td>    
    <td colspan="2"><em>Shippment Fee Not yet Included</em></td>
<td colspan="4" align="right">
<strong>TOTAL COST: <?php echo $currency.number_format($sum); ?></strong>   
<a href="customer-order.php" class="btn btn-primary btn-sm" id="proceedDesktop">PROCEED TO CHECKOUT</a> 
</td>          
</tr>    
<?php echo "</table>"; ?>
    </div>
...
<!--    mobile phone and tablets cart-->
    ...
    <div class="card" id="mobile">
      ...
      <form action="catalog" method="get" class="form-inline"> <div class="input-group">
  <div
class="search-box"> <input type="search" class="form-control here" placeholder="Search for products"
id="mobileSearch" name="term" style="width: 300" autocomplete="off" required="required"/> <div class="result"></div> </div>
<div class="input-group-append"> <button type="submit" class="btn btn-light"><i class="fa fa-search
text-primary"></i></button> </div> </div> </form> </div>
      <?php echo $cart_status; ?> 
                 ...
                 <?php echo $currency.number_format($sum); ?>&nbsp;<small class="text-muted">Shippment Fee Not yet Included</small>   
                    ...
                    <div class="input-group">
                      <div class="card mt-2" style="border: none;">
                          <div class="card-body">
                          <a href="HOME.php" class="btn btn-primary btn-sm"><i class="fas fa-arrow-left"></i> Continue Shopping</a>
                          </div>
                    </div> <div class="card mt-2"  style="border: none;">
                          <div class="card-body">
                             <a href="customer-order.php" class="btn btn-success btn-sm" id="proceedMobile">PROCEED TO CHECKOUT <i class="fas fa-arrow-right"></i></a> 
                    </div>
                        </div></div> </div>
                <?php }else{
	echo "
