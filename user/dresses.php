...
<script>
  ...
  <meta name="author" content="Tumuhimbise Usher Godwin">
    ...
    <title>Categories/Dresses</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<!-- side bar -->
    ...
    <span class="text-secondary"><?php echo $dresses_status; ?></span>       
     <form method='post' action=''>
   <div class="container">
     <?php echo $status; ?>
        <div class="row">
        <?php foreach($dresses as $key => $row):?>
        <div class="col-sm-12 col-md-6 col-lg-3">
            ...
            <input type='hidden' name='code' value="<?php echo $row['code'];?>" />
              <input type='hidden' name='category' value="<?php echo $row['category'];?>" />
                ...
                <p class="text-info">UGX: <?php echo $row['status']; ?></p> <hr> 
