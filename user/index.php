<?php include('db.php'); require("cart-logic.php"); require('messages.php'); require('categories-logic.php'); require_once 'online.php';
?>
<html>
<head>
...
<script type="text/javascript">$(document).ready(function(){$("[data-toggle = tooltip]").tooltip();});</script>
    ...
    padding-right: 20px; top: 5px; margin-left: 10px; font-size: 15px; text-align: center;} #dropdown-link a{color: black} #mobile_nav{width: 100%} #card-call a:hover{text-decoration: none}.fa-phone-alt{background-color: orange; color: aliceblue; font-size: 20pt; border: 2px solid orange; border-radius: 50%;} #card-call a{font-weight: 600} .fa-money-check-alt{font-size: 20pt; background-color: orange; color: aliceblue; border: 2px solid orange; border-radius: 5px;} .fa-check-circle{background-color: orange; color: green; font-size: 20pt;border: 2px solid orange; border-radius: 50%;} #dropdown-link a:hover{text-decoration: none}
        #tablets_nav a{color: aliceblue} #tablets_nav a:hover{text-decoration-color: orange; text-decoration: underline} #tablets_nav{background-color: rgba(0,0,0,1);}.description:hover{cursor: pointer;}
        ...
        @media only screen and (min-width: 1200px) {#mobile_nav{display: none} #top_nav{display: inline-flex; width: 100%} #desktop_view{display: inline-flex} #mobile_view{display: none} #tablets_nav{display: none} }#description:hover{text-decoration: none}.card-size{max-width: 300px;} #login{color: orange} #dropdown2-link a{color: orange}
...
<nav class="navbar navbar-expand-md sticky-top" id="top_nav"><a href="index.php" class="navbar-brand"><img src="imgs/gemasglam.jpg" height="70" width="150" style="border-radius: 5px;"></a><div class="collapse navbar-collapse justify-content-between" id="navbarCollapse"><div class="navbar-nav"></div> <form action="catalog.php" method="get" class="form-inline"><div class="input-group"><div class="search-box">                    <input type="search" class="form-control here" placeholder="Search for products" id="search" name="term" style="width: 450" autocomplete="off" required="required"/> <div class="result"></div></div><div class="input-group-append"><button type="submit" class="btn btn-light"><i class="fa fa-search text-primary"></i></button></div></div></form>  <div class="nav-item dropdown"><a href="#" class="dropdown-toggle text-light" data-toggle="dropdown"><h5 class="text-warning">Hi, <?php echo $got['firstname']; ?></h5></a><div class="dropdown-menu" id="dropdown-link"> <a href="user-account.php" class="dropdown-item"><i class="fas fa-user-check text-primary"></i> My Account</a> <a href="user-account.php" class="dropdown-item"><i class="fas fa-cog text-primary"></i>  Settings</a> <hr><a href="logout.php" class="dropdown-item"><button class="btn btn-outline-warning btn-sm">Logout</button></a></div></div>  <a href="cart.php"><span id="cart_count">&nbsp;<?php echo $cart_count; ?></span><h4><i class="fas fa-shopping-cart text-light"></i></h4></a>  <a href="tel:+256709655944" class="btn btn-outline-warning btn-sm" id="help">HELP?</a> </div></nav>
            ...
            <input type='hidden' name='code' value="<?php echo $row['code'];?>" />
              <input type='hidden' name='category' value="<?php echo $row['category'];?>" />
                ...
                <p class="text-info product-status">UGX: <?php echo $row['status'];?></p><hr> 
                   <p class="text-dark d-inline-block text-truncate" style="max-width: 550pt;"><?php echo $row['description'];?></p><a class="description text-primary" data-toggle="tooltip" title="<?php echo $row['description'];?>">Read More</a>
