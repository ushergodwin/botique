...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <script src="js/purejs.js"></script>
       <script>$(function(){$(".open_admin").click(function(){ $("#hidden").toggle();$("#bar_icon").toggleClass("fas fa-times-circle");$("#bar_icon").toggleClass("fas fa-bars");}); });
     </script>
    ...
    <a href="admin.php" class="btn btn-outline-light btn-sm">ALL ORDERS</a> &nbsp; &nbsp;        
                 <a href="current.php" class="btn btn-outline-light btn-sm active">CURRENT ORDERS <span><?php echo"&nbsp;".$current."&nbsp;"; ?></span></a>&nbsp; &nbsp;     
...
<div class="container-fluid">
  <div id="hidden">
    ...
    <a href="order-status" class="btn btn-outline-light btn-sm">Update Order Status</a><br><br>
