...
<script>
  ...
  <meta name="author" content="Tumuhimbise Usher Godwin">
	<title>GemasGlamHome How To Buy</title>
...
<script type="text/javascript">$(document).ready(function(){$("#next1").on("click", function(){$("#step2").slideToggle(1000); $("#step1").slideUp()}); $("#next2").on("click", function(){$("#step3").slideToggle(1000); $("#step2").slideUp();}); $("#next3").click(function(){$("#step4").slideToggle(1000); $("#step3").slideUp();}); $("#next4").click(function(){$("#step5").slideToggle(1000); $("#step4").slideUp();});$("#next5").click(function(){$("#step6").slideToggle(1000); $("#step5").slideUp();});$("#finish").click(function(){$("#step1").slideDown(1000); $("#step6").slideUp();}); });</script>
<style type="text/css">@media (max-width: 600px){#step2{display: none;}#step3{display: none;}#step4{display: none;}#step5{display: none;}#step6{display: none;}}@media (min-width: 600px){#step2{display: block;}#step3{display: block;}#step4{display: block;}#step5{display: block;}#step6{display: block;} #next1{display: none;}#next2{display: none;}#next3{display: none;}#next4{display: none;}#next5{display: none;}#finish{display: none;}}@media (min-width: 768px){#step2{display: block;}#step3{display: block;}#step4{display: block;}#step5{display: block;}#step6{display: block;} #next1{display: none;}#next2{display: none;}#next3{display: none;}#next4{display: none;}#next5{display: none;}#finish{display: none;}}@media (min-width: 992px){#step2{display: block;}#step3{display: block;}#step4{display: block;}#step5{display: block;}#step6{display: block;} #next1{display: none;}#next2{display: none;}#next3{display: none;}#next4{display: none;}#next5{display: none;}#finish{display: none;}}@media (min-width: 1200px){#step2{display: block;}#step3{display: block;}#step4{display: block;}#step5{display: block;}#step6{display: block;} #next1{display: none;}#next2{display: none;}#next3{display: none;}#next4{display: none;}#next5{display: none;}#finish{display: none;}}
#top_nav{background-color: rgba(0,0,0,1);} #top_nav a{color: aliceblue} #top_nav a:hover{text-decoration-color: orange; text-decoration: underline} #mobile_nav{background-color: rgba(0,0,0,1);} #mobile_nav a{color: aliceblue} #mobile_nav a:hover{text-decoration-color: orange; text-decoration: underline} #card{width: 350px;} #cart_count{border: 2px solid orange; border-radius: 50%; background-color: orange; color: white; position: absolute;
    width: 18px;
    height: 13px;
    padding-bottom: 20px;
...
<div class="col-md-12 col-lg-12 col-sm-12">
	<div class="card">
        <h4 class="card-header text-light bg-dark">Here are the steps to follow to buy on gemasglam Home</h4>
		<div class="card-body">
         <div class="row">
             <div class="col-md-6 col-lg-4 col-sm-12" id="step1">
              <div class="card">
                <h4 class="text-light bg-dark">STEP 1</h4>
                  <div class="card-body">
                  <h5 class="text-muted"><a href="user/Create-Account"> Create an account</a> with GemasGlamHome.<br>A link to confirm your account will be sent to your email address. Click on it to verify your account, and you will be redirected our login page<br><button type="button" class="btn btn-warning btn-sm" id="next1">NEXT</button><br><br><br></h5>    
                  </div>
              </div>  
         </div>
          <div class="col-md-6 col-lg-4 col-sm-12" id="step2">
              <div class="card">
                <h4 class="text-light bg-dark">STEP 2</h4>
                  <div class="card-body">
                  <h5 class="text-muted"><a href="user/user-login">Login</a> by entering your <b>email</b> and <b>password</b> that you used when creating and account. You will be redirected the home page. seach for a product you want to buy, by name<img src="imgs/search.PNG" width="330" id="search_pic_mobile"><img src="imgs/search2.PNG" width="330" id="search_pic_desktop"> or click on the categories dropdown and navigate through our categories <button type="button" class="btn btn-warning btn-sm" id="next2">NEXT</button> </h5>    
                  </div>
              </div>  
         </div> 
             <div class="col-md-12 col-lg-4 col-sm-12" id="step3">
              <div class="card">
                <h4 class="text-light bg-dark">STEP 3</h4>
                  <div class="card-body">
                  <h5 class="text-muted">Click on <b>Add To Cart</b> button of the product that you would like to buy. Click on the cart icon on the top navigation bar and perform actives like selecting the quantity and size of the product(s). Once done with that, click on <b>Proceed To Checkout</b> Button to go to checkout <button type="button" class="btn btn-warning btn-sm" id="next3">NEXT</button></h5>    
                  </div>
              </div>  
         </div> 
	</div>
             <div class="row">
             <div class="col-md-6 col-lg-4 col-sm-12" id="step4">
              <div class="card mt-2">
                <h4 class="text-light bg-dark">STEP 4</h4>
                  <div class="card-body">
                  <h5 class="text-muted">Check the <b>Address Details</b> of your account. if not valid, click on <b>edit</b> button and provide valid address detail. Choose a <b>a Delivery method</b> and then Click on the <b>Proceed To The Next Step</b> button to go to the payment method <button type="button" class="btn btn-warning btn-sm" id="next4">NEXT</button><br><br><br></h5>    
                  </div>
              </div>  
         </div>
          <div class="col-md-6 col-lg-4 col-sm-12" id="step5">
              <div class="card mt-2">
                <h4 class="text-light bg-dark">STEP 5</h4>
                  <div class="card-body">
                  <h5 class="text-muted">Choose a <b> a payment method</b> either <b>cash On delivery</b> or <b>Mobile Money</b> if you choose mobile money, please follow the steps that will guide you to do online transactions. Click on the <b>Confirm</b> button to confirm your order <button type="button" class="btn btn-warning btn-sm" id="next5">NEXT</button><br><br><br><br></h5>    
                  </div>
              </div>  
         </div> 
             <div class="col-md-12 col-lg-4 col-sm-12" id="step6">
              <div class="card mt-2">
                <h4 class="text-light bg-dark">STEP 6</h4>
                  <div class="card-body">
                      <h5 class="text-muted">The <b>Order Received</b> notification will be availed to you and an email will be sent to the email you provided when creating your account. Our customer service will call you on the number that you provided to confirm your order. You can then go to <b>my account >></b> Tracker my Order to see how your order progresses.<br><button type="button" class="btn btn-warning btn-sm" id="finish">FINISH</button> </h5>    
                  </div>
              </div>  
         </div> 
    </div>
