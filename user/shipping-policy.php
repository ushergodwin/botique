...
<script>
  ...
  <meta name="author" content="Tumuhimbise Usher Godwin">
	<title>GemasGlamHome Shipping Plicy</title>
...
src="imgs/dress.png" width="40" height="40" style="border-radius: 50%"> Dresses</a> <a href="beauty-products.php"
class="dropdown-item"> <img src="imgs/beauty.PNG" width="40" height="40" style="border-radius: 50%">Beauty Products</a>
</div> </div> &nbsp; <form action="catalog.php" method="get" class="form-inline"><div class="input-group"><div class="search-box"> <input type="search" class="form-control" placeholder="Search for products" id="search" name="term" style="width: 250" autocomplete="off" required="required"/> <div class="result"></div></div><div class="input-group-append"><button type="submit" class="btn btn-light"><i class="fa fa-search text-primary"></i></button></div></div></form>&nbsp; <div class="nav-item dropdown" id="dropdown2-link"><a href="#" class="dropdown-toggle text-light" data-toggle="dropdown"><h5 class="text-warning">Hi, <?php echo $got['firstname']; ?></h5></a><div class="dropdown-menu" id="dropdown-link"> <a href="user-account.php" class="dropdown-item"><i class="fas fa-user-check text-primary"></i> My Account</a> <a href="user-account.php" class="dropdown-item"><i class="fas fa-cog text-primary"></i>  Settings</a> <hr><a href="logout.php" class="dropdown-item"><button class="btn btn-outline-warning btn-sm">Logout</button></a></div></div><a href="cart.php"><span id="cart_count">&nbsp;<?php echo $cart_count; ?></span><h4><i class="fas fa-shopping-cart text-light"></i></h4></a> &nbsp;&nbsp; <a href="tel:+256709655944" class="btn btn-outline-warning btn-sm" id="help">HELP?</a> </div></nav> <!-- end of  -->
...
<div class="col-md-12 col-lg-12 col-sm-12">
	...
	<div class="card">
		<div class="card-body">
			<h5 class="text-muted">To ensure that your package is properly delivered and you receive shipment within the time frame we advertise, please make sure your address is fully entered and correct. Use correct abbreviations and have spaces inserted properly. If there are issues with verifying your address, customer service will contact you to try and resolve these issues.<br><br>If you realize that you entered your shipping address incorrectly, please contact as soon as possible on<a href="tel:+256709655944"> +256709655944</a> OR<a href="mailto:wecare@gemasglam.com"> wecare@gemasglam.com</a>
We will do our best to fulfill your request and change the address. If we are unable to, we do not take responsibility for the incorrect information.
. If your tracking information states that your package was delivered and you have not received it. You must take this up with the DHL Postal service. Gemasglam Home does not hold responsibility for packages that state is delivered. Shipping fees are non-refundable.
<br> Just a reminder that you will receive your order 1-2business days from the date that it is shipped out, not necessarily from the date that it is placed. After your payment is authorized and verified, it can still take a day to process your order. This is just an estimate, though, and doesn't include weekends or holidays. When your order has been shipped, you will receive an email with tracking information. If your order says delivered and you did not receive it, you must contact your local post office. We do not issue a refund for packages that state being delivered.
 <br> <h4 class="text-light bg-dark">INTERNATIONAL ORDERS:</h4></h5> <h5 class="text-muted">The rates may vary for international orders depending on where you live, certain countries add fees after the package has been accepted there. We are not responsible for these additional costs. The shipping rate will be displayed during checkout before you submit payment. Shipping can also take up to 15 days.
</h5>
	</div>
</div>	
</div>
