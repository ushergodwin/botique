...
font-weight-bold">Loggedin as: <?php echo $firstname; ?></span>&nbsp;<span id="time" class="text-light"></span></h5> &nbsp; &nbsp; <a href="#" class="text-light">Home /<small class="text-warning">Admin</small> / <small class="text-secondary">Setting</small> </a> </div><a href="#hide-bottom-bar.asp" class="nav-item nav-link d-flex flex-column
...
<div class="w3-container">  
    ...
    <div class="card-body">
       <div class="row">
        ...
        <div class="card-body">
                 <h5 class="text-warning">Welocome, &nbsp;<?php echo $firstname ."&nbsp;".$lastname; ?></h5>     
                </div>           
            </div>    
        </div>
      </div>
        ...
        <div class="col-md-6 col-lg-4">       
         ...
         <div class="card mt-4">
            ...
            <div class="card-body">
                ...
                <div class="saving"><h5><span class="spinner-border spinner-border-sm text-primary"></span><small>saving...</small></div>
             </div>
            </div>
            </div>
