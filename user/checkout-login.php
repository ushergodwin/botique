...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <style type="text/css">body{background-image: url(imgs/IMG-20200727-WA0018.jpg)} .form-control{border-left: none; border-right: none; border-top: none;} #input:focus{outline: none;} </style>
</head>
<body>
	<div class="container">
  	...
  	<h2 style="text-align: center">Login To Checkout</h2>
  ...
  <form method="post" action="checkout-login.php">
  	<?php include('errors.php'); ?>
  		<label for="email" class="control-label">E-Mail</label><br>
  		<input type="email" name="email" class="form-control" id="input" value="<?php echo @$_COOKIE['cid'];?>" required><br>
...
<button type="submit" class="btn btn-warning" name="checkout">Login</button> 
