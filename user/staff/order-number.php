   ...
   <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top p-3">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <form class="form-inline ml-auto">
            <input type="text" class="form-control mr-sm-2" placeholder="search by name" id="myOrder" onkeyup="searchFunction()">
            <button type="submit" class="btn btn-outline-light">Search</button>
        </form>
          <div class="navbar-nav">
            <a href="#" class="nav-item nav-link"><small><span class="badge badge-light messages" id="top-badge"></span></small><h4><i class="fas fa-bell"></i></h4></a>
...
<div class="w3-container">  
    ...
    <h5 class="card-header py-1"> <i class="fas fa-shopping-basket"></i> ORDERS NUMBERS <small><span class="badge badge-light current"></span></small></h5>
    <div class="card-body">
