   ...
   <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top p-3">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav">
            ...
            <a href="current" class="nav-item nav-link"><i class="fas fa-shopping-basket"></i> Current Orders <small><span class="badge badge-light current" id="top-badge"></span></small></a>
        </div>
        <form class="form-inline ml-auto">
          ...
          <div class="navbar-nav">
            <a href="#" class="nav-item nav-link"><small><span class="badge badge-light messages" id="top-badge">2</span></small><h4><i class="fas fa-bell"></i></h4></a>
...
<div class="w3-container">  
    ...
    <h5 class="card-header py-1"> <i class="fas fa-shopping-basket"></i> CURRENT ORDERS <small><span class="badge badge-light current"></span></small></h5>
    <div class="card-body">
      <div class="table-responsive">
        <div id="currentOrders"> <small><span class="spinner-border spinner-border-sm"></span> loadingData</small></div>
      </div>
        </div>    
    </div>
        </div>
