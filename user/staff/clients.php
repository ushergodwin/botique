...
<div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left bg-dark text-light font-weight-bold" id="mySidebar">
  ...
  <a href="all-order" class="w3-bar-item w3-button">ALL ORDERS &nbsp;<span class="badge badge-light"><?php echo $no_of_orders; ?></span></a><hr>
   ...
   <nav class="navbar navbar-expand-md navbar-dark bg-dark sticky-top p-3">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <form class="form-inline ml-auto">
          ...
          <div class="navbar-nav">
            <a href="#" class="nav-item nav-link"><small><span class="badge badge-light" id="top-badge"><?php echo $messages_count; ?></span></small><h4><i class="fas fa-envelope"></i></h4></a>
...
<div class="w3-container">  
    ...
    <h5 class="card-header py-1">USERS <i class="fas fa-user"></i></h5>
        <a name="edit_users"></a>
    <div class="card-body">
