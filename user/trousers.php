<?php
require_once("db.php"); require('categories-logic.php'); require('messages.php'); require_once 'cart-logic.php';
$currency = "UGX ";
?>
<html>
<head>
...
<script>
  ...
  <meta name="author" content="Tumuhimbise Usher Godwin">
    ...
    <title>Categories/Trousers</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<script type="text/javascript">$(document).ready(function(){$("[data-toggle = tooltip]").tooltip();});</script>
    ...
    padding-right: 20px; top: 5px; margin-left: 10px; font-size: 15px; text-align: center;} #dropdown-link a{color: black} #mobile_nav{width: 100%} #card-call a:hover{text-decoration: none}.fa-phone-alt{background-color: orange; color: aliceblue; font-size: 20pt; border: 2px solid orange; border-radius: 50%;} #card-call a{font-weight: 600} .fa-money-check-alt{font-size: 20pt; background-color: orange; color: aliceblue; border: 2px solid orange; border-radius: 5px;} .fa-check-circle{background-color: orange; color: green; font-size: 20pt;border: 2px solid orange; border-radius: 50%;} #dropdown-link a:hover{text-decoration: none}
        ...
        @media only screen and (min-width: 1200px) {#mobile_nav{display: none} #top_nav{display: inline-flex; width: 100%} #desktop_view{display: inline-flex} #mobile_view{display: none} #tablets_nav{display: none} }#description:hover{text-decoration: none}.card-size{max-width: 250px;} #login{color: orange} #dropdown2-link a{color: orange}
...
<nav class="navbar navbar-expand-md sticky-top" id="tablets_nav"><a href="index.php" class="navbar-brand"><img src="imgs/gemasglam.jpg" height="50" width="100" style="border-radius: 5px;"></a><div class="collapse navbar-collapse justify-content-between" id="navbarCollapse"><div class="nav-item dropdown"> <a href="#" class="nav-link dropdown-toggle"
            ...
            <input type='hidden' name='code' value="<?php echo $row['code'];?>" />
              <input type='hidden' name='category' value="<?php echo $row['category'];?>" />
                ...
                <p class="text-info product-status">UGX: <?php echo $row['status'];?><hr> 
                   <p class="text-muted d-inline-block text-truncate" style="max-width: 550pt;"><?php echo $row['description'];?></p><a href='#' data-toggle="tooltip" title="<?php echo $row['description'];?>" id="description">Read More</a>
              ...
              <div class="col-md-6 col-lg-6">
                  <div class="card mt-3">
                      ...
                      <p style="font-size: 20pt;"> <a href="tel:+256709655944"> <i class="fas fa-phone-alt"></i> +256709655944 &nbsp;</a></p>
                       <p style="font-size: 20pt;"><a href ="mailto:sales@gemasglam.com"><i class="fas fa-envelope"></i> wecare@gemasglam.com</a></p>  
